...
function DisplayItemPage() {
    ...
    const [object, setObject] = useState({idItem: '', itemType: '', itemCategory: '', itemName: '', brand: '', qty: '', price: '', status: ''});
    ...
    return (
        <div className="item-display-container">
            <form className="item-display-form">
                <div className="item-display-section1">
                <section>
                ...
                <div className="item-display-section2">
                <section>
                ...
                <div className="item-display-section3">
                <section>
